  ...
  private static String editer ="标题测试";
		...
		public static boolean JspToHtmlFile(String filePath, String HtmlFile) {
            ...
            str = str.replaceAll("###author###",
                editer);//替换掉模块中相应的地方
                        ...
                        OutputStreamWriter streamWriter = new OutputStreamWriter(new FileOutputStream(f), "GBK");
                        BufferedWriter o = new BufferedWriter(streamWriter);
                        o.write(str);
                        o.close();
        ...
        public static boolean JspToHtmlByURL(String u, String path) {
                ...
                try {
                        ...
                        OutputStreamWriter streamWriter = new OutputStreamWriter(new FileOutputStream(f), "UTF-8");
                        BufferedWriter o = new BufferedWriter(streamWriter);
                        o.write(str);
                        o.close();
                        str = "";
    ...
    //循环生成20个html文件
                for (int k = 0; k < 20; k++) {
                        String url = "E:\\test\\moban\\moban\\mb.html";//模板文件地址
                        String savepath = "E:\\test\\moban\\file\\" + k + ".html";//生成文件地址
